...
# Image to download the Pharo VM to be used
...
# Download the Pharo image to use
...
# Copy the Pharo image into a loader image and build the app
FROM vm as loader
...
# expose desired ports and make it run 
